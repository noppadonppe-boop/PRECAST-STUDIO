  ...
  return (
    <Routes>
      ...
      <Route path="/org/:orgId" element={<RequireOrganizationMembership><AppShell /></RequireOrganizationMembership>}>
        ...
        <Route path="libraries" element={<Placeholder title="Engineering libraries" detail="M3 records explicit material, joint and anchor references; managed library authoring remains future work." />} />
